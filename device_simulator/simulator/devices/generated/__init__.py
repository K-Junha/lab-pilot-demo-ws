...
from . import weightmeasurement


class Client(SilaClient):

    WeightMeasurement: weightmeasurement.WeightMeasurementClient
    ...
    _expected_features: Set[FullyQualifiedFeatureIdentifier] = {
        ...
        FullyQualifiedFeatureIdentifier("org.silastandard/measurement/WeightMeasurement/v1"),
    }
